...
const renderRow = (user) => (
  ...
  <Chip
    label={user.votedOption}
    size="small"
    sx={{
      backgroundColor:
        user.votedOption === "Option A" ? "#7B49FF" :
        user.votedOption === "Option B" ? "#FA457E" :
        user.votedOption === "Option C" ? "#FFA500" : 
        "#00BFFF",
      color: "white",
      fontWeight: 'bold',
    }}
