...
export default function UserList() {
  ...
  const renderRow = (user, idx) => (
    <tr key={user.id} className="border-b hover:bg-gray-50">
      ...
      <td className="py-2 px-3 space-x-4 whitespace-nowrap">
        <button onClick={() => navigate("/usersProfile")} className="text-blue-600 hover:underline">View</button>
        {user.blocked ? (
  ...
  return <TableLayout title="Users List" headers={headers} data={users} renderRow={renderRow} />;
}
